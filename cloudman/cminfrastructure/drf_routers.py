"""Consolidate all of the DRF and custom routers."""
...
class HybridRoutingMixin(object):
    """
    Extend DefaultRouter to allow registering API views, not just Viewsets.
    ...
    def get_routes(self, viewset):
        """
        Check if the viewset is an instance of ViewSet.

        Otherwise, assume it's a simple view and does not run original
        `get_routes` code.
        """
