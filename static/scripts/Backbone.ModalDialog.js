...
Backbone.ModalView =
    Backbone.View.extend(
    {
        ...
        defaultOptions:
		{
            ...
            slideDistance: 150,
			closeImageUrl: "/cloud/static/images/delete_icon.png",
			closeImageHoverUrl: "/cloud/static/images/delete_icon_dark.png",
                    ...
                    var image =
                        $("<a href='#' id='modalCloseButton'>&#160;</a>")
                            ...
                            .hover(
                                function()
                                {
                                    $(this).css( "background-image", "url(" + view.options.closeImageHoverUrl + ")");
                                },
                                function()
                                {
                                    $(this).css( "background-image", "url(" + view.options.closeImageUrl + ")");
                                })
                            .click(
                                function( event)
                                {
